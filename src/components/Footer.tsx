    ...
    <footer className="site-footer">
      <div className="shell">
        <div className="site-footer__main">
          ...
          <div className="site-footer__contact"><a href={links.instagram} target="_blank" rel="noopener noreferrer"><Instagram size={17} /> Instagram</a><a href={buildWhatsappLink(whatsappMessages.information)} target="_blank" rel="noopener noreferrer"><MessageCircle size={17} /> WhatsApp</a></div>
        </div>
